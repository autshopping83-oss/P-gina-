    ...
    <div className="min-h-screen bg-white py-20 px-6">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-[#374151] leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-[#1F2937] mb-4">1. Introdução</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1F2937] mb-4">2. Informações que Recolhemos</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1F2937] mb-4">3. Como Utilizamos as Suas Informações</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1F2937] mb-4">4. Partilha de Dados</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1F2937] mb-4">5. Segurança</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1F2937] mb-4">6. Os Seus Direitos</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1F2937] mb-4">7. Contacto</h2>
            <p>
