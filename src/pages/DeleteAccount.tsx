    ...
    <div className="min-h-screen bg-white py-20 px-6">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-red-50 border border-red-100 rounded-[2.5rem] p-8 md:p-16 text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold font-display text-[#1F2937]">Eliminar Conta</h1>
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex items-center justify-center gap-3 text-[#6B7280] font-medium">
          ...
          <div className="grid md:grid-cols-2 gap-6 pt-8">
            <a 
              ...
              className="flex flex-col items-center gap-4 p-8 bg-white rounded-3xl shadow-sm border border-[#E5E7EB] hover:shadow-xl hover:border-[#1A73E8] transition-all group"
            >
              <div className="w-14 h-14 bg-[#D0F1FF] rounded-2xl flex items-center justify-center group-hover:bg-[#1A73E8] transition-colors">
                <MessageSquare className="text-[#0D47A1] w-7 h-7 group-hover:text-white transition-colors" />
              </div>
              <div className="text-center">
                <div className="text-sm font-bold text-[#9CA3AF] uppercase tracking-widest mb-1">WhatsApp</div>
                <div className="text-lg font-bold text-[#1F2937]">+258 840 636 794</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-center">
                <div className="text-sm font-bold text-[#9CA3AF] uppercase tracking-widest mb-1">Linha de Apoio</div>
                <div className="text-lg font-bold text-[#1F2937]">+258 840 636 797</div>
              </div>
            </a>
          </div>

          <p className="text-[#9CA3AF] text-sm pt-8">
