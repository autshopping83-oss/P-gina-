    ...
    <div className="min-h-screen bg-white py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Responsabilidades do Utilizador</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Pagamentos e Subscrições</h2>
            <p>
