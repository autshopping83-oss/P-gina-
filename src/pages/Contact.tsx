    ...
    <div className="min-h-screen bg-white py-20 px-6">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-start">
          <div>
            <p className="text-sm uppercase tracking-[0.4em] text-emerald-600 font-bold">Contato</p>
            <h1 className="text-5xl md:text-6xl font-bold font-display mt-4">Precisa de ajuda para crescer com Biz-flow?</h1>
            <p className="text-slate-600 text-lg mt-4 max-w-2xl">Nossa equipa em Maputo está pronta para responder a todas as suas dúvidas e ajudar na implementação do sistema na sua empresa.</p>

            <div className="mt-12 grid gap-6 sm:grid-cols-2">
              <a href="https://wa.me/258840636794" target="_blank" rel="noopener noreferrer" className="rounded-[2rem] border border-slate-200 p-8 hover:border-emerald-500 transition-all bg-slate-50">
                <div className="flex items-center gap-4 mb-4 text-emerald-600">
                  <Phone className="w-6 h-6" />
                  <span className="font-bold">WhatsApp</span>
                </div>
                <p className="text-slate-700">+258 840 636 794</p>
              </a>
              <a href="tel:+258840636797" className="rounded-[2rem] border border-slate-200 p-8 hover:border-emerald-500 transition-all bg-slate-50">
                <div className="flex items-center gap-4 mb-4 text-emerald-600">
                  <Phone className="w-6 h-6" />
                  <span className="font-bold">Telefone</span>
                </div>
                <p className="text-slate-700">+258 840 636 797</p>
              </a>
              <a href="mailto:contato@biz-flow.cloud" className="rounded-[2rem] border border-slate-200 p-8 hover:border-emerald-500 transition-all bg-slate-50">
                <div className="flex items-center gap-4 mb-4 text-emerald-600">
                  <Mail className="w-6 h-6" />
                  <span className="font-bold">Email</span>
                </div>
                <p className="text-slate-700">contato@biz-flow.cloud</p>
              </a>
              <div className="rounded-[2rem] border border-slate-200 p-8 bg-slate-50">
                ...
                <p className="text-slate-700">Av. Julius Nyerere 145, Maputo, Moçambique</p>
                <p className="text-slate-500 mt-4 text-sm">GPS: -25.9658, 32.5831</p>
              </div>
            </div>
          </div>
